...
class _ConnectionScreenState extends ConsumerState<ConnectionScreen> {
  ...
  Widget _buildGenerateCodeSection(
      ConnectionServiceState state, bool isElderly) {
          ...
          if (state.activeInviteCode != null) ...[
                      ...
                      OutlinedButton.icon(
                        onPressed: () {
                          Clipboard.setData(ClipboardData(
                              text: state.activeInviteCode!.code));
                      ...
                      OutlinedButton.icon(
                        onPressed: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                  'Share code: ${state.activeInviteCode!.code}'),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(
                    state.isLoading ? 'Generating...' : 'Generate Invite Code'),
          ...
          if (state.error != null) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border:
                    Border.all(color: AppColors.neonRed.withValues(alpha: 0.3)),
              ),
              child: Row(
                children: [
