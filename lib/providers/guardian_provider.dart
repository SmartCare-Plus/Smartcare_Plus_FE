...
class GuardianNotifier extends StateNotifier<GuardianState> {
  ...
  Future<void> loadElderlyList(String? guardianId) async {
    ...
    try {
      ...
      final response =
          await _api.get('/api/guardian/elderly/list', queryParams: params);
  ...
  Future<void> loadAlerts(String guardianId, {String? status}) async {
    ...
    try {
      ...
      final response = await _api.get('/api/guardian/alerts/$guardianId',
          queryParams: params);
      if (response.success && response.data != null) {
  ...
  Future<void> loadActivityLog(String elderlyId, {String? date}) async {
    ...
    try {
      ...
      final response = await _api.get('/api/guardian/activity-log/$elderlyId',
          queryParams: params);
      if (response.success && response.data != null) {
  ...
  Future<void> loadCameras(String? guardianId) async {
    ...
    try {
      final params = guardianId != null ? {'guardian_id': guardianId} : null;
      final response =
          await _api.get('/api/guardian/cameras', queryParams: params);
      if (response.success && response.data != null) {
  ...
  Future<void> acknowledgeAlert(String alertId, String action,
      {String? notes}) async {
    state = state.copyWith(isLoading: true, error: null);
    try {
...
final alertsProvider =
    FutureProvider.family<List<Alert>, String>((ref, guardianId) async {
  final api = ref.watch(apiServiceProvider);
...
final elderlyStatusProvider =
    FutureProvider.family<ElderlyStatus?, String>((ref, elderlyId) async {
  final api = ref.watch(apiServiceProvider);
